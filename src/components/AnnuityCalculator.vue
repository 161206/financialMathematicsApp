                ...
                <v-col cols="6">
                    <v-card  class="ma-3" color="blue-grey lighten-5">
                        ...
                        <v-layout row class="mx-3">
                            <v-col cols="7">
                                <h3  class="indigo--text ">Periodic Cash Flow:</h3>
                            </v-col>
                            <v-col cols="5">
                        ...
                        <v-layout row class="mx-3">
                            <v-col cols="7">
                                <h3  class="indigo--text ">Number of Periods:</h3>
                            </v-col>
                            <v-col cols="2">
                                <v-text-field :label="`${sharedState.select.state}`" v-model="sharedState.time"
                                type="number" min='0'>
                                </v-text-field>
                             </v-col>
                             <v-col cols="3">
                        ...
                        <v-layout row class="mx-3">
                            <v-col cols="7">
                                <h3  class="indigo--text ">Rate Per Period:</h3>
                            </v-col>
                            <v-col cols="5">
...
export default {
    ...
    methods: {
        ...
        calculate() {
            ...
            let result = this.sharedState.principal*((1-Math.pow(1+(this.sharedState.rate/100),-this.sharedState.time))/(this.sharedState.rate/100));
