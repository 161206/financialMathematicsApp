      ...
      <v-card class=" primary--text">
        <v-layout row wrap justify-center class="pa-1">
          <v-flex xs12 sm8 md6 lg6 xl6>
            <div><h2>loan remaining balance calculator</h2></div>
          </v-flex>
        </v-layout>
        <br/>
        <v-layout row wrap justify-center class="pa-1">
        ...
        <v-layout row wrap justify-center class="pa-1">
          ...
          <v-flex xs4 sm2 md2 lg2 xl2>
            <input v-model="sharedState.payment" name="Payment:" type="number" placeholder="Add original principal" min="0" />
          </v-flex>
        </v-layout>
        <v-layout row wrap justify-center class="pa-1">
          <v-flex xs8 sm6 md4 lg4 xl4>
        ...
        <v-layout row wrap justify-center class="pa-1">
          <v-flex xs8 sm6 md4 lg4 xl4>
            <label for="Period">Number of Periods: </label>
...
export default {
  ...
  computed:{
        futureValue: function () {
          const futureValue  = this.sharedState.principal*Math.pow(1+(this.sharedState.rate/100),this.sharedState.time)-this.sharedState.payment*((Math.pow(1+(this.sharedState.rate/100),this.sharedState.time)-1)/(this.sharedState.rate/100)) ;
